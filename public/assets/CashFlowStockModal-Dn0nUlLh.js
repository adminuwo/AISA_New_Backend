              ...
              activeTab === "Historical chart" && tabData["Historical chart"] && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white dark:bg-[#1E2438] rounded-[16px] sm:rounded-[24px] p-3 sm:p-8 border border-gray-100 dark:border-white/8 shadow-sm min-h-[350px] sm:min-h-[700px]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-8 gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 sm:gap-4 flex-wrap", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 sm:gap-4 text-[8px] sm:text-[10px] font-black text-[#5154ff] uppercase tracking-widest bg-[#5154ff]/10 px-2.5 py-1.5 sm:px-4 sm:py-2 rounded-lg", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-2.5 h-2.5 sm:w-3 sm:h-3 animate-pulse" }),
                      " TradingView"
                    ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[280px] sm:h-[550px] w-full pt-2 sm:pt-4 relative rounded-xl overflow-hidden shadow-inner border border-black/5 dark:border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TradingViewWidget, { symbol: selectedStock == null ? void 0 : selectedStock.symbol, interval: "D", containerId: "tv_chart_historical", isDarkMode }) })
              ] }),
