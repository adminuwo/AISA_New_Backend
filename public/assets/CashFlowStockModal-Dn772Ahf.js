var _a;
import { c as createLucideIcon, r as reactExports, ad as lookup, w as axios, ae as reactDomExports, j as jsxRuntimeExports, A as AnimatePresence, m as motion, af as TrendingUp, ag as Minimize2, ah as Maximize2, X, ai as ChevronDown, a0 as Check, aj as LoaderCircle, v as Search, C as CircleAlert, s as Lock, P as Activity, k as Sparkles, E as ExternalLink, H as ChartColumn, ak as ResponsiveContainer, al as Tooltip, Z as Zap, M as BookOpen, e as ChevronRight, l as Shield, G as Globe, am as Markdown, a as apiService, _ as React } from "./index-CifJr-sK.js";
import { M as Maximize } from "./maximize-DfBwxUEP.js";
import { A as AreaChart, X as XAxis, Y as YAxis, a as Area } from "./AreaChart-CkxVvrXl.js";
...
const baseURL = ((_a = window._env_) == null ? void 0 : _a.VITE_AISA_BACKEND_API) || "https://aisa24.com/api";
const PRESET_STOCKS = [
...
const isIndianSymbol = (symbol) => {
  ...
  return upper.endsWith(".BSE") || upper.endsWith(".NSE") || upper.endsWith(".BO") || upper.endsWith(".NS") || ["TCS", "RELIANCE", "HDFCBANK", "INFY", "SBIN", "ICICIBANK"].includes(upper);
};
const CashFlowStockModal = ({ isOpen, onClose, onSelect, isDarkMode, initialStock }) => {
  ...
  const [unlockedTabs, setUnlockedTabs] = reactExports.useState([]);
    ...
    try {
      ...
      if (res.data && Array.isArray(res.data.unlockedTabs)) {
        setUnlockedTabs((prev) => {
          const combined = /* @__PURE__ */ new Set([...prev, ...res.data.unlockedTabs]);
    ...
    if (activeTab === "Realtime chart") {
      ...
      axios.get(`${baseURL}/stock/intraday`, { params, headers }).then((res) => {
        ...
        if (((_a4 = err.response) == null ? void 0 : _a4.status) === 403 && ((_c3 = (_b3 = err.response) == null ? void 0 : _b3.data) == null ? void 0 : _c3.code) === "OUT_OF_CREDITS") {
          ...
          const errMsg = ((_e2 = (_d3 = err.response) == null ? void 0 : _d3.data) == null ? void 0 : _e2.error) || `Failed to load intraday data.`;
          setTabError(errMsg);
        }
      });
      if (socket) {
      ...
      if (socket) {
        setIsLoadingTab(true);
        setTabError(null);
        const token2 = (_d2 = JSON.parse(localStorage.getItem("user") || "{}")) == null ? void 0 : _d2.token;
        socket.emit("request_historical", { symbol: selectedStock.symbol, token: token2 });
      ...
      if (promise) {
        promise.then((result) => {
          ...
          if (((_a4 = err.response) == null ? void 0 : _a4.status) === 403 && ((_c3 = (_b3 = err.response) == null ? void 0 : _b3.data) == null ? void 0 : _c3.code) === "OUT_OF_CREDITS") {
            ...
            const errMsg = ((_e2 = (_d3 = err.response) == null ? void 0 : _d3.data) == null ? void 0 : _e2.error) || `Failed to load ${activeTab}.`;
            setTabError(errMsg);
          }
  ...
  const fetchGrahamAnalysis = async () => {
    ...
    if (!isIndianSymbol(selectedStock == null ? void 0 : selectedStock.symbol)) {
      setTabError("Only Indian stocks are currently available.");
      return;
    }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 sm:max-w-[320px] relative", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isCountryDropdownOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-2 max-h-64 overflow-y-auto custom-scrollbar", children: COUNTRIES.filter((c) => c.supported).map((country) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        onClick: () => {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isStockSelectOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-2", children: searchTerm.length >= 2 && searchResults.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-8 text-center text-rose-500", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-8 h-8 mx-auto mb-2 opacity-80" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-black uppercase tracking-wider", children: "This stock is not supported by the selected market." }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 dark:text-zinc-500 font-bold mt-1", children: "Only Indian stocks are currently available." })
                      ] }) : (searchTerm.length >= 2 ? searchResults : PRESET_STOCKS).map((stock) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "button",
                        {
                          onClick: () => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 sm:px-8 border-b border-gray-100 dark:border-white/5 flex items-center gap-3 sm:gap-10 overflow-x-auto no-scrollbar bg-white dark:bg-[#161B2E] shrink-0", children: ["Realtime chart", "News", "Historical chart", "Advisory", "Research and recommendation"].map((tab) => {
              const tabMap = {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    tab,
                    isUnlocked ? /* @__PURE__ */ jsxRuntimeExports.jsx(LockOpen, { className: "w-3.5 h-3.5 text-emerald-500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-3.5 h-3.5 text-gray-400/80" })
                  ]
                },
                tab
              );
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-3 py-4 sm:px-8 sm:py-8 bg-white dark:bg-[#1E2438] custom-scrollbar", children: isLoadingTab ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col items-center justify-center gap-6 text-[#999] dark:text-zinc-500", children: [
              ...
              activeTab === "Realtime chart" && tabData["Realtime chart"] && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 sm:space-y-8", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white dark:bg-[#1E2438] rounded-[16px] sm:rounded-[24px] p-3 sm:p-8 border border-gray-100 dark:border-white/8 shadow-sm dark:shadow-[0_0_0_1px_rgba(81,84,255,0.05)] min-h-[350px] sm:min-h-[700px]", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[280px] sm:h-[550px] w-full pt-2 sm:pt-4 relative rounded-xl overflow-hidden shadow-inner border border-black/5 dark:border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TradingViewWidget, { symbol: selectedStock == null ? void 0 : selectedStock.symbol, interval: chartInterval, containerId: "tv_chart_realtime", isDarkMode }) })
                ] })
              ] }),
                        ...
                        "button",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 sm:gap-4 min-w-0", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-9 h-9 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-amber-700/40 border border-amber-600/30 flex items-center justify-center shadow-inner shrink-0 relative", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-4 h-4 sm:w-6 sm:h-6 text-amber-300" }),
                                unlockedTabs.includes("graham-analysis") ? /* @__PURE__ */ jsxRuntimeExports.jsx(LockOpen, { className: "w-3 h-3 text-emerald-400 absolute -bottom-1 -right-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-3 h-3 text-amber-400/80 absolute -bottom-1 -right-1" })
                              ] }),
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "button",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 sm:gap-4 min-w-0", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-9 h-9 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-blue-700/40 border border-blue-600/30 flex items-center justify-center shadow-inner shrink-0 relative", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "w-4 h-4 sm:w-6 sm:h-6 text-blue-300" }),
                                unlockedTabs.includes("kiyosaki-analysis") ? /* @__PURE__ */ jsxRuntimeExports.jsx(LockOpen, { className: "w-3 h-3 text-emerald-400 absolute -bottom-1 -right-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-3 h-3 text-blue-400/80 absolute -bottom-1 -right-1" })
                              ] }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left min-w-0", children: [
